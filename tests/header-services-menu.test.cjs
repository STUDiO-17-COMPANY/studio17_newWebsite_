...
const requiredDestinations = [
  ...
  '/wip?for=website-revamp', '/services/free-website', '/services/seo', '/wip?for=geo', '/wip?for=copywriting', '/wip?for=localization-and-translation', '/wip?for=maintenance',
...
for (const locale of ['pt-PT', 'es', 'el', 'ru', 'he']) {
  ...
  for (const key of ['Free Website', 'Copywriting', 'Filming', 'Photography', 'Video editing', 'Graphic design', 'Digital design', 'AI generation', 'Meta ads', 'Google ads', 'Influencer ads', 'SMEs', 'Events', 'Presential Events', 'Online Events', 'Health care', 'Local Business']) {
