...
const html = fs.readFileSync(path.join(root, 'home.template.html'), 'utf8');
...
assert.doesNotMatch(testimonialSection, /Client name|Approved client feedback|\/work#testimonials/);
