...
const UI = {
  en: { back: 'All articles', published: 'Published', reading: 'Reading time', written: 'Written by', role: 'Role', minutes: n => `${n} minutes`, contents: 'In this article', share: 'Share article', continue: 'Continue reading', previous: 'Previous articles', next: 'Next articles', table: 'Article data table' },
  'pt-PT': { back: 'Todos os artigos', published: 'Publicado', reading: 'Tempo de leitura', written: 'Escrito por', role: 'Função', minutes: n => `${n} minutos`, contents: 'Neste artigo', share: 'Partilhar artigo', continue: 'Continue a ler', previous: 'Artigos anteriores', next: 'Artigos seguintes', table: 'Tabela de dados do artigo' },
  es: { back: 'Todos los artículos', published: 'Publicado', reading: 'Tiempo de lectura', written: 'Escrito por', role: 'Cargo', minutes: n => `${n} minutos`, contents: 'En este artículo', share: 'Compartir artículo', continue: 'Seguir leyendo', previous: 'Artículos anteriores', next: 'Artículos siguientes', table: 'Tabla de datos del artículo' },
  el: { back: 'Όλα τα άρθρα', published: 'Δημοσιεύτηκε', reading: 'Χρόνος ανάγνωσης', written: 'Συντάκτης', role: 'Ρόλος', minutes: n => `${n} λεπτά`, contents: 'Σε αυτό το άρθρο', share: 'Κοινοποίηση άρθρου', continue: 'Συνεχίστε την ανάγνωση', previous: 'Προηγούμενα άρθρα', next: 'Επόμενα άρθρα', table: 'Πίνακας δεδομένων άρθρου' },
  ru: { back: 'Все статьи', published: 'Опубликовано', reading: 'Время чтения', written: 'Автор', role: 'Роль', minutes: n => `${n} мин.`, contents: 'В этой статье', share: 'Поделиться статьёй', continue: 'Продолжить чтение', previous: 'Предыдущие статьи', next: 'Следующие статьи', table: 'Таблица данных статьи' },
  he: { back: 'כל המאמרים', published: 'פורסם', reading: 'זמן קריאה', written: 'נכתב על ידי', role: 'תפקיד', minutes: n => `${n} דקות`, contents: 'במאמר זה', share: 'שיתוף המאמר', continue: 'המשך קריאה', previous: 'מאמרים קודמים', next: 'המאמרים הבאים', table: 'טבלת נתוני המאמר' }
};
...
const renderArticleMain = article => {
  ...
  return `<main id="article-content"><article data-i18n-skip>
    ...
    ${hasRelated ? `<section class="article-related" aria-labelledby="related-title" data-related-carousel><div class="shell article-related-heading"><h2 class="design-heading" id="related-title"><span>${escapeHtml(ui.continue)}</span></h2>${article.related.length > 3 ? `<div class="article-related-controls"><button type="button" data-related-prev aria-label="${escapeAttribute(ui.previous)}"><i data-lucide="arrow-left" aria-hidden="true"></i></button><button type="button" data-related-next aria-label="${escapeAttribute(ui.next)}"><i data-lucide="arrow-right" aria-hidden="true"></i></button></div>` : ''}</div><div class="shell article-related-viewport"><div class="article-related-track" data-related-track>${article.related.map(item => renderCard(item, locale)).join('')}</div></div></section>` : ''}
  </article></main>`;
};
