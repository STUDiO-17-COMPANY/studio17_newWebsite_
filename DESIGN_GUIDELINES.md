...
- Reuse the homepage closing CTA when there is a meaningful contact action. The general Services page is the approved media-led variation: a tightly cropped 292 × 164px image replaces the decorative icon while retaining the shared CTA dimensions and responsive stacking.
