...
const cleanPages = new Map([
  ...
  ['/services/website', 'website-services.html'],
  ['/services/website-development', 'website-development.html'],
...
const legacyPages = new Map([
  ...
  ['/website-services.html', '/services/website'],
  ['/website-services', '/services/website'],
  ['/website-development.html', '/services/website-development'],
  ['/website-development', '/services/website-development'],
  ['/website-pricing.html', '/services/website-pricing'],
  ['/website-pricing', '/services/website-pricing'],
  ['/free-website.html', '/services/free-website'],
  ...
  ['/seo-cyprus', '/seo/cyprus'],
  ['/seo-limassol.html', '/seo/limassol'],
  ['/seo-limassol', '/seo/limassol'],
  ['/news.html', '/news'],
  ['/article.html', '/news'],
